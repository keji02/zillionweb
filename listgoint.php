...
<div id="content" class="p-4 p-md-5">
    ...
    <div class="page-header" style="background-image: url(static/images/prot3.jpg);">
        <h3 class="display 4" id="welcometitle">Gene interactors</h3>
...
<br>
    ...
    $sqlz = "SELECT  interactors.id ,interactors.symbol FROM `uniprot2go`,`interactors` WHERE interactors.id=uniprot2go.GeneID AND uniprot2go.GOId='$goid'";
