...
<div id="content" class="p-4 p-md-5">
    ...
    <div class="page-header" style="background-image: url(static/images/prot3.jpg);">
        <h3 class="display 4" id="welcometitle">GO Term Uniprot Details</h3>
...
<br>
    ...
    $sqlz = "SELECT uniprot.uniprot_AC,uniprot.uniprot_ID,uniprot.name,uniprot.function FROM `uniprot2go`,`interactors`,`uniprot` WHERE interactors.id=uniprot2go.GeneID AND uniprot2go.GeneID=uniprot.gene_ID  AND uniprot2go.GOId='$goid' ";
